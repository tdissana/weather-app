const baseUrl = 'https://weather-app-server-kwxb.onrender.com';
...
function displayWeatherInfo(data) {
  ...
  const descDisplay = (document.getElementById("descDisplay").textContent =
    description);
  const emojiDisplay = (document.getElementById("emojiDisplay").textContent =
    getEmoji(id));
}
